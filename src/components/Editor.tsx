...
// Accept props
export default function Editor({ selectedFilePath, currentFileSha, onContentLoaded }: EditorProps) {
  ...
  }, [selectedFilePath, editor, onContentLoaded]); // Rerun when path or editor changes
